...
const (
	...
	OK = BASS_Error(C.BASS_OK)
	// BASS_ERROR_MEM as defined in bass.h:62
	ERROR_MEM = BASS_Error(C.BASS_ERROR_MEM)
	// BASS_ERROR_FILEOPEN as defined in bass.h:63
	ERROR_FILEOPEN = BASS_Error(C.BASS_ERROR_FILEOPEN)
	// BASS_ERROR_DRIVER as defined in bass.h:64
	ERROR_DRIVER = BASS_Error(C.BASS_ERROR_DRIVER)
	// BASS_ERROR_BUFLOST as defined in bass.h:65
	ERROR_BUFLOST = BASS_Error(C.BASS_ERROR_BUFLOST)
	// BASS_ERROR_HANDLE as defined in bass.h:66
	ERROR_HANDLE = BASS_Error(C.BASS_ERROR_HANDLE)
	// BASS_ERROR_FORMAT as defined in bass.h:67
	ERROR_FORMAT = BASS_Error(C.BASS_ERROR_FORMAT)
	// BASS_ERROR_POSITION as defined in bass.h:68
	ERROR_POSITION = BASS_Error(C.BASS_ERROR_POSITION)
	// BASS_ERROR_INIT as defined in bass.h:69
	ERROR_INIT = BASS_Error(C.BASS_ERROR_INIT)
	// BASS_ERROR_START as defined in bass.h:70
	ERROR_START = BASS_Error(C.BASS_ERROR_START)
	// BASS_ERROR_SSL as defined in bass.h:71
	ERROR_SSL = BASS_Error(C.BASS_ERROR_SSL)
	// BASS_ERROR_ALREADY as defined in bass.h:72
	ERROR_ALREADY = BASS_Error(C.BASS_ERROR_ALREADY)
	// BASS_ERROR_NOCHAN as defined in bass.h:73
	ERROR_NOTAUDIO=BASS_Error(C.BASS_ERROR_NOTAUDIO)
	ERROR_NOCHAN = BASS_Error(C.BASS_ERROR_NOCHAN)
	// BASS_ERROR_ILLTYPE as defined in bass.h:74)
	ERROR_ILLTYPE = BASS_Error(C.BASS_ERROR_ILLTYPE)
	// BASS_ERROR_ILLPARAM as defined in bass.h:75
	ERROR_ILLPARAM = BASS_Error(C.BASS_ERROR_ILLPARAM)
	// BASS_ERROR_NO3D as defined in bass.h:76
	ERROR_NO3D = BASS_Error(C.BASS_ERROR_NO3D)
	// BASS_ERROR_NOEAX as defined in bass.h:77
	ERROR_NOEAX = BASS_Error(C.BASS_ERROR_NOEAX)
	// BASS_ERROR_DEVICE as defined in bass.h:78
	ERROR_DEVICE = BASS_Error(C.BASS_ERROR_DEVICE)
	// ERROR_NOPLAY as defined in bass.h:79
	ERROR_NOPLAY = BASS_Error(C.BASS_ERROR_NOPLAY)
	// BASS_ERROR_FREQ as defined in bass.h:80
	ERROR_FREQ = BASS_Error(C.BASS_ERROR_FREQ)
	// BASS_ERROR_NOTFILE as defined in bass.h:81
	ERROR_NOTFILE = BASS_Error(C.BASS_ERROR_NOTFILE)
	// BASS_ERROR_NOHW as defined in bass.h:82
	ERROR_NOHW = BASS_Error(C.BASS_ERROR_NOHW)
	// BASS_ERROR_EMPTY as defined in bass.h:83
	ERROR_EMPTY = BASS_Error(C.BASS_ERROR_EMPTY)
	// BASS_ERROR_NONET as defined in bass.h:84
	ERROR_NONET = BASS_Error(C.BASS_ERROR_NONET)
	// BASS_ERROR_CREATE as defined in bass.h:85
	ERROR_CREATE = BASS_Error(C.BASS_ERROR_CREATE)
	// BASS_ERROR_NOFX as defined in bass.h:86
	ERROR_NOFX = BASS_Error(C.BASS_ERROR_NOFX)
	// BASS_ERROR_NOTAVAIL as defined in bass.h:87
	ERROR_NOTAVAIL = BASS_Error(C.BASS_ERROR_NOTAVAIL)
	// BASS_ERROR_DECODE as defined in bass.h:88
	ERROR_DECODE = BASS_Error(C.BASS_ERROR_DECODE)
	// BASS_ERROR_DX as defined in bass.h:89
	ERROR_DX = BASS_Error(C.BASS_ERROR_DX)
	// BASS_ERROR_TIMEOUT as defined in bass.h:90
	ERROR_TIMEOUT = BASS_Error(C.BASS_ERROR_TIMEOUT)
	// BASS_ERROR_FILEFORM as defined in bass.h:91
	ERROR_FILEFORM = BASS_Error(C.BASS_ERROR_FILEFORM)
	// BASS_ERROR_SPEAKER as defined in bass.h:92
	ERROR_SPEAKER = BASS_Error(C.BASS_ERROR_SPEAKER)
	// BASS_ERROR_VERSION as defined in bass.h:93
	ERROR_VERSION = BASS_Error(C.BASS_ERROR_VERSION)
	// BASS_ERROR_CODEC as defined in bass.h:94
	ERROR_CODEC = BASS_Error(C.BASS_ERROR_CODEC)
	// BASS_ERROR_ENDED as defined in bass.h:95
	ERROR_ENDED = BASS_Error(C.BASS_ERROR_ENDED)
	// BASS_ERROR_BUSY as defined in bass.h:96
	ERROR_BUSY = BASS_Error(C.BASS_ERROR_BUSY)
	ERROR_UNSTREAMABLE = BASS_Error(C.BASS_ERROR_UNSTREAMABLE)
	// BASS_ERROR_UNKNOWN as defined in bass.h:97
	ERROR_UNKNOWN = BASS_Error(C.BASS_ERROR_UNKNOWN)
